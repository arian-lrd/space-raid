...
class Settings():
    ...
    def __init__(self):
        ...
        self.bg_image_done = pygame.transform.scale(self.bg_image_raw, (1500, 1000))
        self.space_craft_scale = (70, 70)
        ...
        self.game_speedup_scale = 1.3
        self.ship_speedup_scale = 1.15
    ...
    def increase_speed(self):
        ...
        self.bullet_speed_factor *= self.game_speedup_scale
        self.alien_speed_factor *= self.game_speedup_scale
