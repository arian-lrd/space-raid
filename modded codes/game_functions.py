...
def check_keydown_events(event, ai_settings, screen, ship, bullets, stats,
    ...
    if event.key == pygame.K_RIGHT:
        ...
        with open('all_time_high.json') as f_obj:
            ...
            #TODO: Add a feature that stores all scores in a json file regardless of how good or bad they are
            #      This requires prompting the players for their user name in the beggining of the game
...
def draw_instructions(screen):
    ...
    font_instructions1 = pygame.font.Font(
        'fonts/Arial Bold Italic.ttf', 20)
    instructions_image1 = font_instructions1.render(
        "  To start the game: click on the play button or press 'P'  ",
        True, instructions_color)
    ...
    instructions_image2 = font_instructions2.render(
        "  To quit the game: click on the close button or press 'Q'  ",
        True, instructions_color)
    ...
    font_instructions3 = pygame.font.Font(
        'fonts/Arial Bold Italic.ttf', 20)
    instructions_image3 = font_instructions3.render(
        "  To shoot: press the Space Bar  ",
        True, instructions_color)
    instructions_image3_rect = instructions_image3.get_rect()
    instructions_image3_rect.centerx = screen_rect.centerx
    instructions_image3_rect.bottom = instructions_image1_rect.top - 10

    screen.blit(instructions_image3, instructions_image3_rect)
